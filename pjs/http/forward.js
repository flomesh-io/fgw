...
function selectTarget() {
  ...
  $svcRes = serviceLoadBalancers.get(route.BackendService)()
  var service = $ctx.parent.config.Services[$svcRes.target.id]
  if (!service) return false

  $epRes = endpointLoadBalancers.get(service.Endpoints)()
  return Boolean($epRes)
}
...
var endpointLoadBalancers = new algo.Cache(
  endpoints => {
    var lb = new algo.LoadBalancer(
