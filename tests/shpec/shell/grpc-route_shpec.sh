...
describe "SHPEC grpc route Test"
  ...
  start="$(date +%s%3N)"
  output_header1_8846="$(curl -s -i -k -H 'host:test.com' -H 'canary:true' -H 'version:2' -H 'region:gz' https://127.0.0.1/com.example.GreetingService/Hello)"
  output_header2_8847="$(curl -s -i -k -H 'host:test.com' -H 'canary:true' -H 'version:2' https://127.0.0.1/com.example.secure/login)"
  ...
  output_method1_8846="$(curl -s -i -k -H 'host:test.com' -H 'canary:true' -H 'version:2' -H 'region:gz' https://127.0.0.1/com.example.GreetingService/Hello)"
  output_method2_8847="$(curl -s -i -k -H 'host:test.com' -H 'canary:true' -H 'version:2' -H 'region:gd' https://127.0.0.1/com.example.secure/login)"
