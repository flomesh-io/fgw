...
describe "SHPEC request redirect Test"
  ...
  it "returns a 301 status code"
    assert grep "$output" 'HTTP/1.1 301 Moved Permanently'
  end

  it "redirect location"
    assert grep "$output" 'Location: https://www.test.com:8443/abc'
  end
